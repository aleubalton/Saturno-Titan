...
public interface AgendaRepository extends JpaRepository<Agenda, Long> {
    ...
    @Query(value = "select distinct agenda from Agenda agenda left join fetch agenda.horarios left join fetch agenda.horarioEspecials left join fetch agenda.diaNoLaborables",
    ...
    @Query("select agenda from Agenda agenda left join fetch agenda.horarios left join fetch agenda.horarioEspecials left join fetch agenda.diaNoLaborables where agenda.id =:id")
