...
export class DiaNoLaborableComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.diaNoLaborableService
            ...
            .subscribe(
                (res: HttpResponse<IDiaNoLaborable[]>) => this.paginateDiaNoLaborables(res.body, res.headers),
    ...
    private paginateDiaNoLaborables(data: IDiaNoLaborable[], headers: HttpHeaders) {
