...
export class TipoServicioComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.tipoServicioService
            ...
            .subscribe(
                (res: HttpResponse<ITipoServicio[]>) => this.paginateTipoServicios(res.body, res.headers),
    ...
    trackId(index: number, item: ITipoServicio) {
        return item.id;
    }
    ...
    private paginateTipoServicios(data: ITipoServicio[], headers: HttpHeaders) {
