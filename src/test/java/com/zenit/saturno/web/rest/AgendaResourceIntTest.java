...
public class AgendaResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = "?z@[4.17.3.1]";
    private static final String UPDATED_EMAIL = "\"(h\"@[8.85.740.0]";
    ...
    public void createAgenda() throws Exception {
        ...
        assertThat(testAgenda.getEmail()).isEqualTo(DEFAULT_EMAIL);
    ...
    public void updateAgenda() throws Exception {
        ...
        assertThat(testAgenda.getEmail()).isEqualTo(UPDATED_EMAIL);
