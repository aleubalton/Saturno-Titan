...
public class ClienteResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = "|z@[240.6.2.489]";
    private static final String UPDATED_EMAIL = "W@kc.z.Hi";

    private static final Integer DEFAULT_DNI = 0;
    private static final Integer UPDATED_DNI = 1;
