...
public class HorarioEspecialResourceIntTest {
    ...
    public void createHorarioEspecial() throws Exception {
        ...
        assertThat(testHorarioEspecial.getHora()).isEqualTo(DEFAULT_HORA);
        assertThat(testHorarioEspecial.getDuracion()).isEqualTo(DEFAULT_DURACION);
    ...
    public void checkDuracionIsRequired() throws Exception {
        int databaseSizeBeforeTest = horarioEspecialRepository.findAll().size();
        // set the field null
        horarioEspecial.setDuracion(null);
    ...
    public void updateHorarioEspecial() throws Exception {
        ...
        assertThat(testHorarioEspecial.getHora()).isEqualTo(UPDATED_HORA);
        assertThat(testHorarioEspecial.getDuracion()).isEqualTo(UPDATED_DURACION);
