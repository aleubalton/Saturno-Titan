...
public class HorarioResourceIntTest {
    ...
    public void createHorario() throws Exception {
        ...
        assertThat(testHorario.getHoraDesde()).isEqualTo(DEFAULT_HORA_DESDE);
        assertThat(testHorario.getHoraHasta()).isEqualTo(DEFAULT_HORA_HASTA);
    ...
    public void updateHorario() throws Exception {
        ...
        assertThat(testHorario.getHoraDesde()).isEqualTo(UPDATED_HORA_DESDE);
        assertThat(testHorario.getHoraHasta()).isEqualTo(UPDATED_HORA_HASTA);
