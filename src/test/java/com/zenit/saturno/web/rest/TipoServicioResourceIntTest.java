...
public class TipoServicioResourceIntTest {
    ...
    private static final Boolean DEFAULT_ADICIONAL = false;
    private static final Boolean UPDATED_ADICIONAL = true;
    ...
    public void createTipoServicio() throws Exception {
        ...
        assertThat(testTipoServicio.isAdicional()).isEqualTo(DEFAULT_ADICIONAL);
    ...
    @Test
    @Transactional
    public void checkAdicionalIsRequired() throws Exception {
        int databaseSizeBeforeTest = tipoServicioRepository.findAll().size();
        // set the field null
        tipoServicio.setAdicional(null);
    ...
    public void checkTipoRecursoIsRequired() throws Exception {
        int databaseSizeBeforeTest = tipoServicioRepository.findAll().size();
        // set the field null
        tipoServicio.setTipoRecurso(null);
    ...
    public void getAllTipoServicios() throws Exception {
        ...
        restTipoServicioMockMvc.perform(get("/api/tipo-servicios?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].adicional").value(hasItem(DEFAULT_ADICIONAL.booleanValue())))
    ...
    public void getTipoServicio() throws Exception {
        ...
        restTipoServicioMockMvc.perform(get("/api/tipo-servicios/{id}", tipoServicio.getId()))
            ...
            .andExpect(jsonPath("$.adicional").value(DEFAULT_ADICIONAL.booleanValue()))
    ...
    public void updateTipoServicio() throws Exception {
        ...
        assertThat(testTipoServicio.isAdicional()).isEqualTo(UPDATED_ADICIONAL);
